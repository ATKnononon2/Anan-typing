document.addEventListener('DOMContentLoaded', () => {
    ...
    // - 用語の定義
        ...
        { main: '眠いなら立ってれば良いんですよ。', sub: 'ねむいならたってればよいんですよ。', inp: 'nemuinaratatterebaiindesuyo.' },
        { main: 'お昼が一番眠くなるんだよ。', sub: 'おひるがいちばんねむくなるんだよ。', inp: 'ohirugaitibannemukunarundayo.' },
        { main: '制作と作成の違い分かってる？', sub: 'せいさくとさくせいのちがいわかってる？', inp: 'seisakutosakuseinotigaiwakatteru?' },
        { main: 'この授業の為に子供からミニカーを取り上げてきた。', sub: 'このじゅぎょうのためにつかさからミニカーをとりあげてきた。', inp: 'konojyugyounotameniokanokaraminika-wotoriagetekita.' },
        { main: 'Youtubeで育った息子はどうなるのか実験中だ。', sub: 'Youtubeでそだったむすこはどうなるのかじっけんちゅうだ。', inp: 'Youtubedeyodattamusukowodou naru no ka jikkenshuchuda.' },
        { main: '課題研究で放置して、どこまで出来るか実験している。', sub: 'かだいけんきゅうできどこまでできるかじっけんしている。', inp: 'kadaikenkyuude dokomade dekiru ka jikkenshiteiru.' },
        { main: '最近コーラが高くなって、飲めなくなっちったんだよ。', sub: 'さいきんこーらがたかくなって、のめなくなっちったんだよ。', inp: 'saikinkooragatakatte,nonemunakunacchittanda yo.' },
        { main: '自販機からコーラが無くなって、先生悲しい。', sub: 'じはんきからこーらがなくって、せんせいかなしい。', inp: 'jihankikarakooraganakutte,senseikana shii.' },
        { main: '阿南先生、今度鳥取行ってきます。', sub: 'あなんせんせい、こんどとっとりいってきます。', inp: 'anansenseikonndotottoriittekimasu.' },
        { main: '行ってきましたよ、鳥取砂丘。', sub: 'いってきましたよ、とっとりさきゅう。', inp: 'ittekimasu yo, tottorisakkyuu.' },
        { main: '俺はIT未来に20年しがみ付く！', sub: 'おれはITみらいに20ねんしがみつく！', inp: 'orehaITmiraninifteen-nenshigamitsuku!' },
        { main: '次の産フェア茨城の時には、阿南は先生じゃなくなっている。', sub: 'つぎのさんふぇあいっしゅうのときには、あなんはせんせいじゃなくなっている。', inp: 'tsuginosanfeai-shuunotoki ni wa, ananha-senseijanaku natte iru.' },
        { main: '皆さん知っていますか。', sub: 'みなさんしっていますか。', inp: 'minasan shittte imasu ka.' },
        { main: '阿南先生の残業時間は過労死ラインを超えています。', sub: 'あなんせんせいのざんぎょうじかんはかろうしらいんをこえています。', inp: 'anansenseinozangyouno jikanhakaroushairinwo koete imasu.' },
        { main: '阿南先生は、嬉しい。', sub: 'あなんせんせいは、うれしい。', inp: 'anansenseiha,ureshii.' },
        { main: '阿南先生は目標を達成したんですよ。', sub: 'あなんせんせいはもくひょうをたっせいしたんですよ。', inp: 'anansenseihamokuhyouwotasseishita ndesuyo.' },
        { main: 'キーボードの位置が変わってて、一年生になんて説明すればいいんですか。', sub: 'きーぼーどのいちがかわってて、いちねんせいになんてせつめいすればいいんですか', inp: 'kii-boodonichigakawatte, ichinen-sei ni nante setsumei sureba iin desu ka' },
        { main: 'だから阿南の言う通りにしておけばとは敢えて言いませんが。', sub: 'だからあなんのいうとおりにしておけばとはあえていいます。', inp: 'dakara anan no iu toori ni shite okeba to wa aete iimasu.' },
        { main: '阿南先生は肖像権NGなんですよ。', sub: 'あなんせんせいはしょうぞうけんNGなんですよ。', inp: 'anansenseiha shouzouken NG nan desuyo.' },
        { main: '急遽阿南はお休みになりました。', sub: 'きゅうきょくあなんはおやすみになりました。', inp: 'kyuukyoku ananha oyasumi ni narimashita.' },
        { main: 'Canvaがアツいんですよ。', sub: 'いまこれ！きゃんばがあついんですよ。', inp: 'ima kore! kyamba ga atsui ndesuyo.' },
        { main: '阿南先生の休日のご予定はなんですか? 仕事です。', sub: 'あなんせんせいのきゅうびつのごよていはなんですか? しごとです。', inp: 'anansenseino kyuubitsugoyoteiha nandesu ka? shigoto desu.' },
        { main: '阿南の言葉は譲り受けなんですよ。', sub: 'あなんせんせいのことばはゆずりうけなんですよ。', inp: 'anansenseino kotobaha yuzuriuke nan desuyo.' },
        { main: '', sub: '', inp: '' },
        { main: '', sub: '', inp: '' },
        { main: '', sub: '', inp: '' },
        { main: '', sub: '', inp: '' },
