document.addEventListener('DOMContentLoaded', () => {
    ...
    // - 用語の定義
        ...
        { main: 'Geminiが使えない奴は、社会で役に立たない。', sub: '', inp: '' },
        { main: 'これからはAIが使えるか使えないかで', sub: '', inp: '' },
        { main: 'Geminiと会話できない奴は社会でも会話できない。', sub: '', inp: '' },
        { main: '阿南先生の言葉が知りたいんだったら、小沢一郎の言葉を調べるといいですよ。', sub: '', inp: '' },
        { main: 'かみさか〇〇さんとお友達になる方法', sub: 'marumaru', inp: '' },
        { main: '', sub: '', inp: '' },
        { main: '', sub: '', inp: '' },
        { main: '', sub: '', inp: '' },
        { main: '', sub: '', inp: '' },
