document.addEventListener('DOMContentLoaded', () => {
    ...
    const words = [
        ...
        { main: '阿南先生、今度鳥取行ってきます。', sub: 'あなんせんせい、こんどとっとりいってきます。', inp: 'anansensei,kondotottoriittekimasu.' },
        ...
        { main: 'Geminiが使えない奴は、社会で役に立たない。', sub: 'Geminiがつかえないやつは、しゃかいでやくにたたない。', inp: 'Geminigatukaenaiyatuha,syakaideyakunitatanai.' },
