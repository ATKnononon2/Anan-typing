document.addEventListener('DOMContentLoaded', () => {
    ...
    const words = [
        ...
        { main: '忙しい人は沢山います。', sub: 'いそがしいひとはたくさんいます。', inp: 'isogasiihitohatakusannimasu.' },
        ...
        { main: 'キーボードの位置が変わってて、一年生になんて説明すればいいんですか。', sub: 'きーぼーどのいちがかわってて、いちねんせいになんてせつめいすればいいんですか。', inp: 'ki-bo-donoitigakawattete,itinenseininantesetumeisurebaiindesuka.' },
        { main: 'だから阿南の言う通りにしておけばとは敢えて言いませんが。', sub: 'だからあなんのいうとおりにしておけばとはあえていいませんが。', inp: 'dakaraanannnoiutoorinisiteokebatohaaeteiimasenga.' },
        ...
        { main: 'Geminiと会話できない奴は社会でも会話できない。', sub: 'Geminiとかいわできないやつはしゃかでもかいわできない。', inp: 'Geminitokaiwadekinaiyatuhasyakaidemokaiwadekinai.' },
        { main: '阿南の言葉が知りたいんだったら、小沢一郎を調べるといいですよ。', sub: 'あなんのことばがしりたいんだったら、おざわいちろうをしらべるといいですよ。', inp: 'anannnokotobawosiritaindattara,ozawaitirouwosiraberutoiidesuyo.' },
        ...
        { main: '今日の夜も明日の朝もやった方が効率がいい。', sub: 'きょうのよるもあしたのあさもやったほうがこうりつがいい。', inp: 'kyounoyorumoasitanoasamoyattahougakouritsugaii.' },
        ...
        { main: '結局、学び続けなければならない。', sub: 'けっきょく、まなびつづけなければならない。', inp: 'kekyoku,manabitudukenakerebanaranai.' },
        { main: '一緒に働きたいと思える人になれるかどうか', sub: 'いっしょにはたらきたいとおもえるひとになれるかどうか。', inp: 'issyonihatarakitaitoomoeruhitoninarerukadouka.' },
        { main: '阿南先生は偉大ですから。', sub: 'あなんせんせいはいだいですから。', inp: 'anansenseihaidaidesukara.' },
    ...
    function gameOver() {
        ...
        // ユーザーへのメッセージ
        messageElement.textContent = 'お疲れ様でした。';
        messageElement.style.color = '#d9534f';
